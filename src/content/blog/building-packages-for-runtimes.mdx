---
title: "Building runtime aware JavaScript packages"
description: "Building javascript packages for respective runtimes, for better compatability and cross-platform usage."
pubDate: "11 March 2023"
---

import {Image} from 'astro:assets'
import Exports from '../../assets/exports.svg'

<Image src={Exports} alt="Exports" width={600} height={400} />

One of the great things about JavaScript is how easy it is to share modules with package managers like `npm` `pnpm`, and `yarn`, developers can easily publish their code as packages and share them with the world and distribute them across with global cdn’s like `jspm`.
...
<a href="https://ga.jspm.io/npm:chalk@5.2.0/source/vendor/supports-color/index.js">https://ga.jspm.io/npm:chalk@5.2.0/source/vendor/supports-color/index.js</a>
<a href="https://ga.jspm.io/npm:chalk@5.2.0/source/vendor/supports-color/browser.js">https://ga.jspm.io/npm:chalk@5.2.0/source/vendor/supports-color/browser.js</a>

<img alt="Chalk animation" src="/chalk.gif" />
...
> We can deprecate all these fields in favour of [exports](#exports) now.
