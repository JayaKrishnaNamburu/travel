...
I enjoy reverse engineering more than the actual development phase. Yes, initially it was always a concern for me. *"How we can dive into a code that is written by someone else"*. But now I can answer: Over time, we will get the hang of it.
I then started contributing to some projects here and there, and everytime my PR gets merged, I am **all above the sky** :)
...
At that time, they were looking for a changelog and versioning setup, and as a person with interest in infrastructure, I quickly started to look at options, suggested a few and did a initial implementation. You can view my <Link href="https://github.com/teleporthq/teleport-code-generators/pull/77"> first PR </Link>

It was a small one, but my current colleagues <Link href="https://twitter.com/alexnmoldovan">@alexnmoldovan</Link>, <Link href="https://twitter.com/agilius">@agilius</Link> and <Link href="https://twitter.com/Utwoo">@Utwoo</Link>, who were the repo maintainers at that
time helped me figure things out. Yeah, I was dead scared to ask anything at that time :D 
...
Next, we wanted to migrate the current setup to a monorepo based packages setup, to expand the eco-system and bring in plug-in system to the generators. And this was the time, when I buried my mind inside it and was able to rewamp the architecture to a lerna based <Link href="https://github.com/teleporthq/teleport-code-generators/pull/177">monorepo</Link>.
...
After a couple of days, I received a text from <Link href="https://twitter.com/alexnmoldovan">@alexnmoldovan</Link> saying that I was officially being invited to come onboard the team. I couldn't sleep that night with all the excitement!
...
Apart from work, we have *Tech Tuesdays*, *coffee breaks* and some *games* where we try to understand each other and get some time off from work.
...
- #### What would you suggest for someone who wants to start working remotely?
  ...
  - If you can have a *dedicated room*, it would take the experience up a notch. I personally suggest this. If we are able to separate the room where we work from the other places where we eat or have some entertainment, it helps in *zoning out* from all the non-work thoughts and gets you into the mood for work.
  ...
  - Plan your meetings properly and do *homework* on what to discuss or what you want to ask before joining a call. 
    In a traditional office environment, you can have adhoc discussions with anyone on the floor. Sometimes may be when you eat or have coffee together. But when you are remote, you need to have a *scheduled meetings* when you want to have some discussions. We need to consider the persons *timezone*, *availability* and *meetings scheduled* and not to interrupt their *workflow*.
...
- #### Why we need to consider contributing to OSS
  ...
  - You get to work on multiple projects with different backgrounds and architectures. 
    It helps in gaining, *quick adaption* nature which helps when you want to work with a completly new project.
...
So far, the past *6 months* was an amazing experience for me. I want to thank everyone who helped me in the journey and mainly <Link href="https://twitter.com/alexnmoldovan">@alexnmoldovan</Link> and team, for having faith in me and onboarding me. I personally learned a lot, and helped in improving the technology we had and still in the process of exploring.
