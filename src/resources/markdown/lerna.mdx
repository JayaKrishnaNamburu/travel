...
[_lerna-changelog_](https://github.com/lerna/lerna-changelog) is a PR based changelog management tool. Every PR speaks only about one entity, it can be either a _fix_, a _feature_, or an _enhancement._ A release notes or the changelog with all the PR’s merged makes the notes look much cleaner.
