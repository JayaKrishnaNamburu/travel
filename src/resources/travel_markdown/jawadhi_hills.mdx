...
<figure>
  <img
    ...
    src={require(`../../compressed/jawadhihills/1.jpg`)}
    alt="Our bikes, at a pitstop"
  />
  <figcaption>Our Bikes, at a pitstop</figcaption>
</figure>
...
And believe me, although the route we took extended our riding time, it was worth it.
    ...
    <PostImage
    src={require(`../../compressed/jawadhihills/road.jpg`)}
...
<div className="splitPost">
<PostImage
    src={require(`../../compressed/jawadhihills/service_bike.jpg`)}
...
<PostImage src={require(`../../compressed/jawadhihills/water_falls.jpg`)} alt="Beeman waterfalls" caption="Beeman waterfalls" /> 
...
<PostImage
    src={require(`../../compressed/jawadhihills/detour.jpg`)}
...
- If the weather is on your side, you can camp in the forest. Else, you'd have to adjust like us in a backyard :D
  ...
  <PostImage src={require(`../../compressed/jawadhihills/tent_stay.jpg`)} alt="" caption="" />
</div>

<div className="splitPost">
<PostImage src={require(`../../compressed/jawadhihills/clouds.jpg`)} alt="Hilltop view from Swami Malai" caption="Hilltop view from Swami Malai" />
<div>
