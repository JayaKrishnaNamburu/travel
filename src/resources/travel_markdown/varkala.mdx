...
import { Suggestion } from '../../components/PostUtils';
...
<PostImage
  ...
  caption="Stars in tehnight sky"
/>

My picture might not be doing the proper justice, but belive me since the place is way from the city lights pollution.
