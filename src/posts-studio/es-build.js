    ...
    <div className={styles.container}>
      ...
      <div className={styles.container1}>
        ...
        <p className={styles.text004}>
          <span>The state of Javascript development</span>
          <span className={styles.text006}> tooling</span>
          <span>
            {' '}
            is exiting and moving at much faster pace than ever. JavaScript being a high level and
          ...
          <br></br>
          <span>
            One major advantage is, the learning curve is little easier because, the feedback loop
        ...
        <p className={styles.text018}>
          ...
          <span>
            {' '}
            and many other build time and development time targeting tools. Has mad the life of
            ...
            comes when the applications starts to grow bigger and bigger.
          </span>
        </p>
        <p className={styles.text028}>
          ...
          <br></br>
          <span>Why should i bother, moving my build pipelines to use</span>
          <span className={styles.text034}> esbuild</span>
          <span> ?</span>
          <br></br>
          <span className={styles.text038}></span>
          <br></br>
          <span>There is a hight chance of you listening about</span>
          <span className={styles.text041}> esbuild</span>
          <span> by now, I could direct you to some of the blogposts that talk about </span>
        ...
        <p className={styles.text046}>
          ...
          <span>. As, the project started growing, we started running into</span>
          <span className={styles.text053}> delays</span>
        ...
        <p className={styles.text063}>
          ...
          <span>
            That takes care of watching the package that just changes and build it, which you can
        ...
        <p className={styles.text071}>
          <span>
            We don&apos;t use Webpack or rollup build tools. Since, we just need to transpile the
            code to
          </span>
          <span className={styles.text073}> es6</span>
          <span>
            {' '}
            and publish to npm. Any bundling, transpiling it more will handled by the users
            consuming the library. That&apos;s the best way to go, or else we might end up bundling
            two times. First when we do it before publishing to npm and once again when the users
        ...
        <p className={styles.text100}>
          ...
          <span>
            {' '}
            script that walks all the packages at depth as 1. And builds the package using
            esbuild&apos;s node-api.
          </span>
        </p>
        <iframe
          title="custom-script"
          src="data:text/html;charset=utf-8,     &lt;head&gt;&lt;base target='_blank' /&gt;&lt;/head&gt;     &lt;body&gt;&lt;script src=&quot;https://gist.github.com/JayaKrishnaNamburu/77582aa77b2ff623bbcfd0ae61e6d8dc.js&quot;&gt;&lt;/script&gt;     &lt;/body&gt;"
          className={styles.iframe}
        ></iframe>
        <p className={styles.text106}>
          A Custom watcher to look for packages, that are going under change and rebuilding them
          again.
        </p>
        <iframe
        ...
        <span className={styles.text107}>
          ...
          <span> to run</span>
          <span className={styles.text111}>tsc</span>
          <span> to generate types alone.</span>
        </span>
        <iframe
          title="npm-scripts"
        ...
        <p className={styles.text113}>
          ...
          <br></br>
          <span>Ok, let&apos;s talk about the results,</span>
        </p>
        <img
          alt="placeholder"
